...
int main()
{
    ...
    eDatos jk= {"Mariano","marianomadou@gmail.com"};
    ...
    do
    {
        ...
        printf("\n");
        printf("6)Datos de BLACK.CSV (ArrayList)\n7)Datos de la DES.CSV(ArrayList)\n");
        printf("\n");
        ...
        {
        case 1:
            printf("\nIngrese el nombre del archivo de destinatarios: ");
            fflush(stdin);
            gets(nameFile);
        ...
        case 2:
            ...
            if((strcmpi("black.csv",nameFile))==0)
            {
                ...
                else
                {
                    ...
                    printf("Datos cargados de lista negra.\n");
                    printf("\nCantidad de datos cargados: %d.-\n",p);
                    fclose(blackList);
                }
        ...
        case 4:
            if(flagD==1)
            {
                printf("Se enviara un correo electronico a las siguientes personas:\n");

            al_push(listaDestinatarios,14,auxJ);//PUSH DE PRUEBA
                ...
                {
                    printf("ATENCION: Primero deben depurarse las listas.\n");
                }
